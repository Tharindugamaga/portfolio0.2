          ...
          <div className="xl:w-[54%] order-2 xl:order-none">
            <form className="flex flex-col gap-6 p-10 bg-[#27272c] rounded-xl">
              ...
              <p className="text-white/60">
                ...
                and user-friendly web solutions. Whether it is crafting dynamic
                websites or solving development challenges, I am here to turn your
                vision into reality. Drop your details below, and let’s create
